...
func RegisterRoutes(e *echo.Echo) {
	...
	stockMovementService := services.NewStockMovementService(database.DB)
	stockService := services.NewStockService(database.DB, userContextService, stockMovementService)
